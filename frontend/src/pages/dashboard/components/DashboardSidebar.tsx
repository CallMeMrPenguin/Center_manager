      ...
      <div className="bg-[#0e1322] border border-[#1e2742] rounded-2xl p-5">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          >
            ...
            <span className="text-xs font-bold text-slate-200">Tiếp nhận học sinh</span>
          </button>
          ...
          >
            ...
            <span className="text-xs font-bold text-slate-200">Báo cáo học vụ</span>
          </button>
        </div>
      </div>

      {/* 2. Operational Shift Noticeboard */}
      <div className="bg-[#0e1322] border border-[#1e2742] rounded-2xl p-5 flex flex-col gap-2">
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-[#13192c] border border-[#1e2844] focus:border-blue-500 rounded-xl p-2.5 text-xs text-slate-200 placeholder:text-slate-500 outline-none resize-none transition"
        />
      </div>
