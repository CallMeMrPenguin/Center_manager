    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#0e1322] border border-slate-200 dark:border-[#1e2742] rounded-2xl p-5 flex flex-col gap-2 shadow-sm dark:shadow-none transition-colors duration-200">
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-slate-50 dark:bg-[#13192c] border border-slate-200 dark:border-[#1e2844] focus:border-blue-500 rounded-xl p-2.5 text-xs text-slate-900 dark:text-slate-200 placeholder:text-slate-500 dark:placeholder:text-slate-500 font-medium outline-none resize-none transition"
        />
      </div>
