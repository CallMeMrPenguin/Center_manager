...
export const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ alerts, onNavigate }) => {
  ...
  return (
    <div className="space-y-6">
      {/* 1. Quick Launchpad */}
      <div className="bg-white dark:bg-[#0e1322] border border-slate-200 dark:border-[#1e2742] rounded-2xl p-5 shadow-sm dark:shadow-none transition-colors duration-200">
        <h2 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3.5">
          Phím Tác Vụ Nhanh
        </h2>
        <div className="grid grid-cols-2 gap-2.5">
          ...
          >
            ...
            <span className="text-xs font-bold text-slate-700 dark:text-slate-200">Tiếp nhận học sinh</span>
          </button>
          ...
          >
            ...
            <span className="text-xs font-bold text-slate-700 dark:text-slate-200">Xếp lịch học</span>
          </button>
          ...
          >
            ...
            <span className="text-xs font-bold text-slate-700 dark:text-slate-200">Tạo đề thi</span>
          </button>
          ...
          >
            ...
            <span className="text-xs font-bold text-slate-700 dark:text-slate-200">Báo cáo học vụ</span>
          </button>
        </div>
      </div>

      {/* 2. Operational Shift Noticeboard */}
      <div className="bg-white dark:bg-[#0e1322] border border-slate-200 dark:border-[#1e2742] rounded-2xl p-5 flex flex-col gap-2 shadow-sm dark:shadow-none transition-colors duration-200">
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-slate-50 dark:bg-[#13192c] border border-slate-200 dark:border-[#1e2844] focus:border-blue-500 rounded-xl p-2.5 text-xs text-slate-900 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none resize-none transition"
        />
      </div>
        ...
        {alerts.length === 0 ? (
          ...
          <div className="space-y-2">
            {alerts.map((al) => (
              <div
                key={al.student_id}
                className="flex items-center justify-between p-2.5 rounded-lg bg-slate-50 dark:bg-[#13192c] border border-slate-200 dark:border-[#1e2844] text-xs"
              >
