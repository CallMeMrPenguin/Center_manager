...
export const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ alerts, onNavigate }) => {
  ...
  return (
    <div className="space-y-6">
      {/* 1. Quick Launchpad */}
      <div className="bg-white dark:bg-[#0e1322] border border-slate-300 dark:border-[#1e2742] rounded-2xl p-5 shadow-sm dark:shadow-none transition-colors duration-200">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          <button
            ...
            className="flex items-center gap-2 p-3 rounded-xl bg-slate-50 hover:bg-slate-100 dark:bg-[#13192c] dark:hover:bg-[#19223c] border border-slate-300 dark:border-[#1e2844] text-left transition cursor-pointer"
          >
      ...
      <div className="bg-white dark:bg-[#0e1322] border border-slate-300 dark:border-[#1e2742] rounded-2xl p-5 flex flex-col gap-2 shadow-sm dark:shadow-none transition-colors duration-200">
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-slate-50 dark:bg-[#13192c] border border-slate-300 dark:border-[#1e2844] focus:border-blue-500 rounded-xl p-2.5 text-xs text-slate-900 dark:text-slate-200 placeholder:text-slate-500 dark:placeholder:text-slate-500 font-medium outline-none resize-none transition"
        />
      </div>
