...
export default function DashboardPage() {
  ...
  return (
    <div className="h-full w-full overflow-y-auto p-6 space-y-6 bg-slate-100 dark:bg-[#090d16] text-slate-800 dark:text-slate-100 select-none font-sans scrollbar-thin">
