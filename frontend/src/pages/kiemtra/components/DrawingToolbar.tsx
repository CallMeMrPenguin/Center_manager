...
export const DrawingToolbar: React.FC<DrawingToolbarProps> = ({
  ...
  return (
    <div
      ...
      className="fixed top-20 right-8 z-[100] pointer-events-auto flex items-center gap-1.5 bg-[#12162a] border-2 border-[#5c36f5]/70 p-1.5 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.6),0_0_20px_rgba(92,54,245,0.35)] select-none ring-1 ring-white/15 transition-all"
    >
      ...
      {isCollapsed ? (
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-[#5c36f5] hover:bg-[#7351f7] text-white text-xs font-black transition cursor-pointer shadow-[0_0_12px_rgba(92,54,245,0.6)]"
        ...
        <>
          ...
          <button
            onClick={onClearAll}
            className="p-1.5 rounded-lg text-slate-300 hover:text-rose-400 hover:bg-rose-500/20 transition cursor-pointer"
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-white/10 transition cursor-pointer border-l border-white/10 ml-0.5"
