...
export const StudentModal: React.FC<StudentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/60 select-none animate-fade-in">
      <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh] font-sans">
        {/* Modal Header */}
        ...
        <form onSubmit={onSave} className="flex-1 overflow-y-auto p-6 space-y-5 scrollbar-thin">
          ...
          <div className="space-y-3.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">Biệt danh (Nickname):</label>
                <VietnameseInput
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">Trạng thái:</label>
                <CustomSelect
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">Trường đang học:</label>
                <VietnameseInput
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">Ngày nhập học:</label>
                <CustomDatePicker
          ...
          {/* SECTION 2: PHỤ HUYNH */}
          <div className="space-y-3.5">
            <h4 className="text-xs font-black uppercase text-sky-600 tracking-wider flex items-center gap-1.5 pb-1 border-b border-slate-200">
              <Phone size={14} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">Họ tên Bố:</label>
                <VietnameseInput
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">Số điện thoại Bố:</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">Họ tên Mẹ:</label>
                <VietnameseInput
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">Số điện thoại Mẹ:</label>
                <input
                  type="text"
          ...
          <div className="space-y-3.5 bg-slate-50 p-4 rounded-xl border border-slate-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">Trạng thái TK:</label>
                <CustomSelect
          ...
          {/* SECTION 4: GHI CHÚ */}
          <div>
            <label className="block text-[11px] font-bold text-slate-700 mb-1">Ghi chú thêm về học sinh:</label>
            <textarea
              rows={2}
