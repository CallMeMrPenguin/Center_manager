...
const THEME_STYLES = {
  blue: {
    ...
    lt: 'text-blue-400',
    input: 'text-blue-300',
    tagBg: 'bg-rose-500/10 hover:bg-rose-500/25 text-rose-300 border-rose-500/25',
    score: 'text-rose-400',
  },
  purple: {
...
export const BelowThresholdCard: React.FC<BelowThresholdCardProps> = ({
  ...
  return (
    <div
      className={`bg-[#080b14] border ${styles.border} rounded-xl p-3 flex flex-col justify-between min-h-[140px]`}
    >
      <div>
        <div className="flex items-center justify-between mb-2 gap-2">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <div className="flex items-center gap-0.5 bg-white/5 hover:bg-white/10 px-1.5 py-0.5 rounded-lg transition-colors">
              ...
              />
              <span className="text-[10px] text-slate-400 font-medium select-none">đ</span>
            </div>
          </div>
          <span
...
export const DivergenceCard: React.FC<DivergenceCardProps> = ({
  ...
  return (
    <div className="bg-[#080b14] border border-amber-500/30 rounded-xl p-3 flex flex-col justify-between min-h-[140px]">
      <div>
