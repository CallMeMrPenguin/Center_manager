...
export const AssignmentsPage: React.FC = () => {
  ...
  if (activeView === 'runner') {
    return (
      <div className="h-full w-full overflow-y-auto p-6 bg-[#f1f5f9] dark:bg-[#09090b] text-slate-900 dark:text-slate-100 font-sans scrollbar-thin">
  ...
  return (
    <div className="h-full w-full overflow-y-auto p-6 space-y-6 bg-[#f1f5f9] dark:bg-[#09090b] text-slate-900 dark:text-slate-100 select-none font-sans scrollbar-thin">
      {/* 1. Header Toolbar */}
      {!isStudent && (
