    ...
    <div className="flex flex-col gap-6 select-none animate-cascade-2">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-2 border-b border-slate-200 dark:border-white/10">
        ...
        <div className="flex flex-wrap items-center gap-2.5 text-xs font-bold">
          <span className="flex items-center gap-1.5 bg-slate-100 dark:bg-[#12182b] border border-slate-200 dark:border-[#232f52] px-2.5 py-1 rounded-lg text-rose-600 dark:text-rose-400">
            <span className="w-2 h-2 rounded-sm bg-rose-500 shadow-[0_0_6px_rgba(244,63,94,0.6)]" />
            Yếu &lt;5.0 ({stats.bands[0].pct}%)
          </span>
          <span className="flex items-center gap-1.5 bg-slate-100 dark:bg-[#12182b] border border-slate-200 dark:border-[#232f52] px-2.5 py-1 rounded-lg text-amber-600 dark:text-amber-400">
            <span className="w-2 h-2 rounded-sm bg-amber-500 shadow-[0_0_6px_rgba(245,158,11,0.6)]" />
            TB 5.0-6.4 ({stats.bands[1].pct}%)
          </span>
          <span className="flex items-center gap-1.5 bg-slate-100 dark:bg-[#12182b] border border-slate-200 dark:border-[#232f52] px-2.5 py-1 rounded-lg text-cyan-600 dark:text-cyan-400">
            <span className="w-2 h-2 rounded-sm bg-cyan-500 shadow-[0_0_6px_rgba(6,182,212,0.6)]" />
            Khá 6.5-7.9 ({stats.bands[2].pct}%)
          </span>
          <span className="flex items-center gap-1.5 bg-slate-100 dark:bg-[#12182b] border border-slate-200 dark:border-[#232f52] px-2.5 py-1 rounded-lg text-emerald-600 dark:text-emerald-400">
