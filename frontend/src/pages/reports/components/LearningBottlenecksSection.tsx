...
export const LearningBottlenecksSection: React.FC<LearningBottlenecksSectionProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-[#0b0f19] rounded-2xl p-6 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.08),0_2px_4px_-1px_rgba(15,23,42,0.04)] dark:shadow-xl space-y-6 animate-cascade-5">
      <div onClick={() => setIsBottlenecksSectionOpen(!isBottlenecksSectionOpen)} className="flex flex-wrap items-center justify-between gap-4 cursor-pointer select-none pb-2">
