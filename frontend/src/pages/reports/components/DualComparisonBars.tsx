...
export const DualComparisonBars: React.FC<DualComparisonBarsProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pt-1 animate-cascade-3">
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-[#090d17] border border-slate-200/90 dark:border-[#192236] shadow-[0_2px_8px_-2px_rgba(0,0,0,0.06),0_1px_3px_-1px_rgba(0,0,0,0.06)] space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-bold text-blue-600 dark:text-blue-400 w-24 truncate shrink-0">{classA.name}:</span>
                <div className="flex-1 h-3 bg-slate-100 dark:bg-[#111726] rounded-md overflow-hidden p-0.5 border border-slate-200/80 dark:border-white/5">
                  <AnimatedProgressBar
                ...
                <span className="text-xs font-mono font-black text-blue-700 dark:text-blue-300 w-12 text-right shrink-0">{format1Dec(classA.avgCheck1)} đ</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-bold text-cyan-600 dark:text-cyan-400 w-24 truncate shrink-0">{classB.name}:</span>
                <div className="flex-1 h-3 bg-slate-100 dark:bg-[#111726] rounded-md overflow-hidden p-0.5 border border-slate-200/80 dark:border-white/5">
                  <AnimatedProgressBar
                ...
                <span className="text-xs font-mono font-black text-cyan-700 dark:text-cyan-300 w-12 text-right shrink-0">{format1Dec(classB.avgCheck1)} đ</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-mono font-black text-blue-700 dark:text-blue-300 w-12 text-right shrink-0">{format1Dec(classA.avgCheck2)} đ</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-bold text-cyan-600 dark:text-cyan-400 w-24 truncate shrink-0">{classB.name}:</span>
                <div className="flex-1 h-3 bg-slate-100 dark:bg-[#111726] rounded-md overflow-hidden p-0.5 border border-slate-200/80 dark:border-white/5">
                ...
                <span className="text-xs font-mono font-black text-cyan-700 dark:text-cyan-300 w-12 text-right shrink-0">{format1Dec(classB.avgCheck2)} đ</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-mono font-black text-blue-700 dark:text-blue-300 w-12 text-right shrink-0">{format1Dec(classA.avgHomework)} đ</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-bold text-cyan-600 dark:text-cyan-400 w-24 truncate shrink-0">{classB.name}:</span>
                <div className="flex-1 h-3 bg-slate-100 dark:bg-[#111726] rounded-md overflow-hidden p-0.5 border border-slate-200/80 dark:border-white/5">
                ...
                <span className="text-xs font-mono font-black text-cyan-700 dark:text-cyan-300 w-12 text-right shrink-0">{format1Dec(classB.avgHomework)} đ</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2.5">
          {TIERS_CONFIG.slice().reverse().map((tier, tierIdx) => {
            ...
            return (
              <div
                key={tier.tier}
                className="bg-slate-50/90 dark:bg-[#0c101d] border border-slate-200 dark:border-[#1b253b] hover:border-indigo-400 dark:hover:border-indigo-500/30 py-2.5 px-4 rounded-xl transition-all duration-200 flex items-center justify-between gap-4 group shadow-xs"
              >
                ...
                <div className="flex-1 flex items-center justify-end gap-3 min-w-0">
                  <span className="text-xs font-mono font-black text-blue-600 dark:text-blue-400 shrink-0">
                    {countA} HS <span className="text-[11px] text-slate-500 dark:text-slate-400 font-normal">({pctA}%)</span>
                  </span>
                  <div className="flex-1 h-3.5 bg-slate-200/70 dark:bg-[#121829] rounded-full overflow-hidden flex justify-end p-0.5 border border-slate-200/60 dark:border-white/5">
                    <AnimatedProgressBar
                ...
                <div className="flex items-center justify-center gap-2.5 w-48 shrink-0 py-1.5 px-3 bg-white dark:bg-[#121728] rounded-xl border border-slate-200 dark:border-white/5 shadow-xs">
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-[10px] text-slate-500 dark:text-slate-400 font-mono font-semibold">{tier.minScore} - {tier.maxScore}đ</span>
                  </div>
                </div>

                {/* RIGHT: Class B Bar & Percentage */}
                <div className="flex-1 flex items-center justify-start gap-3 min-w-0">
                  <div className="flex-1 h-3.5 bg-slate-200/70 dark:bg-[#121829] rounded-full overflow-hidden p-0.5 border border-slate-200/60 dark:border-white/5">
                    <AnimatedProgressBar
                  ...
                  <span className="text-xs font-mono font-black text-cyan-600 dark:text-cyan-400 shrink-0">
                    {countB} HS <span className="text-[11px] text-slate-500 dark:text-slate-400 font-normal">({pctB}%)</span>
                  </span>
                </div>
              </div>
            );
