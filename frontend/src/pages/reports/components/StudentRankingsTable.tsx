...
export const StudentRankingsTable: React.FC<StudentRankingsTableProps> = React.memo(({
  ...
  return (
    <div className={`bg-white dark:bg-[#0d1120] border border-slate-300/80 dark:border-[#1d2644] rounded-2xl flex flex-col shadow-[0_4px_20px_-4px_rgba(15,23,42,0.08),0_2px_4px_-1px_rgba(15,23,42,0.04)] dark:shadow-2xl mb-8 transition-colors ${hasSelectedStudent ? 'animate-cascade-4' : 'animate-cascade-3'}`}>
