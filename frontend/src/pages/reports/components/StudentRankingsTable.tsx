...
export const StudentRankingsTable: React.FC<StudentRankingsTableProps> = React.memo(({
  ...
  return (
    <div className={`bg-white dark:bg-[#0d1120] rounded-2xl flex flex-col shadow-[0_4px_24px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.5)] mb-8 transition-colors ${hasSelectedStudent ? 'animate-cascade-4' : 'animate-cascade-3'}`}>
