...
export const KPICards: React.FC<KPICardsProps> = React.memo(({ stats, isTestMode }) => {
  ...
  return (
    <div className={`grid grid-cols-1 sm:grid-cols-2 ${hasMockTest ? 'lg:grid-cols-5' : 'lg:grid-cols-4'} gap-4`}>
      ...
      <div className="kpi-card-blue p-5 flex flex-col justify-between shadow-2xl transition-all duration-200 min-h-[100px] animate-cascade-1">
        <div>
      ...
      <div className="kpi-card-purple p-5 flex flex-col justify-between shadow-2xl transition-all duration-200 min-h-[100px] animate-cascade-2">
        <div>
      ...
      <div className="kpi-card-green p-5 flex flex-col justify-between shadow-2xl transition-all duration-200 min-h-[100px] animate-cascade-3">
        <div>
      ...
      {hasMockTest && (
        <div className="kpi-card-blue p-5 flex flex-col justify-between shadow-2xl transition-all duration-200 min-h-[100px] animate-cascade-4" style={{ borderColor: 'rgba(245, 158, 11, 0.45)' }}>
          <div>
      ...
      <div className={`kpi-card-amber p-5 flex flex-col justify-between shadow-2xl transition-all duration-200 min-h-[100px] ${hasMockTest ? 'animate-cascade-5' : 'animate-cascade-4'}`}>
        <div>
          <span className="text-[10px] font-black uppercase tracking-wider text-amber-400 block mb-1">
