...
export const ClassBenchmarkTable: React.FC<ClassBenchmarkTableProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-[#0b0f19] border border-slate-300/80 dark:border-[#1b253b] rounded-2xl p-6 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.08),0_2px_4px_-1px_rgba(15,23,42,0.04)] dark:shadow-xl space-y-4 animate-cascade-2">
