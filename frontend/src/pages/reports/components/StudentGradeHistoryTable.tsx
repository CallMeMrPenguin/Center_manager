...
export const StudentGradeHistoryTable: React.FC<StudentGradeHistoryTableProps> = ({
  ...
  return (
    <div className={`bg-white dark:bg-[#141417] border border-slate-200 dark:border-[#27272a] rounded-2xl flex flex-col shadow-sm dark:shadow-xl mb-8 transition-colors ${hasSelectedStudent ? 'animate-cascade-5' : 'animate-cascade-4'}`}>
