...
export function computeSmartGroups({
  ...
  if (groupingMode === 'tier') {
    ...
    const metaConfig = [
      { title: 'Nhóm 1: Dẫn Đầu (Top Tier)', subtitle: 'Cụm Điểm Cao Nhất', pedagogy: 'Nhóm học sinh tiếp thu vượt trội trong lớp. Giao bài tập mở rộng & thử thách tư duy.', borderCls: '', headerBg: 'bg-purple-500/10 dark:bg-[#18142a]', badgeCls: 'bg-purple-500/15 text-purple-700 dark:text-purple-300' },
      { title: 'Nhóm 2: Trung Tâm (Core Tier)', subtitle: 'Cụm Điểm Trung Bình Khá', pedagogy: 'Lực lượng nòng cốt của lớp. Rèn luyện phương pháp làm bài & củng cố kiến thức để tiến vào nhóm dẫn đầu.', borderCls: '', headerBg: 'bg-blue-500/10 dark:bg-[#10182c]', badgeCls: 'bg-blue-500/15 text-blue-700 dark:text-blue-300' },
      { title: 'Nhóm 3: Cần Hỗ Trợ (Focus Tier)', subtitle: 'Cụm Cần Củng Cố Nền Tảng', pedagogy: 'Cụm học sinh cần sự quan tâm đặc biệt. Ôn tập kiến thức cơ bản, sửa lỗi sai thường gặp & kèm cặp sát sao.', borderCls: '', headerBg: 'bg-amber-500/10 dark:bg-[#201810]', badgeCls: 'bg-amber-500/15 text-amber-700 dark:text-amber-300' },
      { title: 'Nhóm 4: Phụ Đạo Tăng Cường (Intensive Tier)', subtitle: 'Cụm Phụ Đạo 1-1', pedagogy: 'Hổng kiến thức nặng. Cần giáo viên hoặc trợ giảng hỗ trợ trực tiếp từng buổi học.', borderCls: '', headerBg: 'bg-rose-500/10 dark:bg-[#241216]', badgeCls: 'bg-rose-500/15 text-rose-700 dark:text-rose-300' },
    ];
