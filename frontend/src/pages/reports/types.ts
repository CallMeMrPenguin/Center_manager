...
export const TIERS_CONFIG: StudentTier[] = [
  { tier: 1, name: 'Đồng', title: 'Yếu', badge: '/ranks/tier_1.png', color: '#d97706', bg: 'bg-amber-700/10', border: 'border-amber-700/30', text: 'text-amber-500', minScore: 0, maxScore: 4.9 },
  { tier: 2, name: 'Bạc', title: 'Trung Bình', badge: '/ranks/tier_2.png', color: '#38bdf8', bg: 'bg-sky-500/10', border: 'border-sky-500/30', text: 'text-sky-400', minScore: 5.0, maxScore: 6.4 },
  ...
  { tier: 6, name: 'Tinh Anh', title: 'Ưu Tú', badge: '/ranks/tier_6.png', color: '#a855f7', bg: 'bg-purple-500/10', border: 'border-purple-500/30', text: 'text-purple-300', minScore: 9.0, maxScore: 9.3 },
  { tier: 7, name: 'Cao Thủ', title: 'Vượt Trội', badge: '/ranks/tier_7.png', color: '#ec4899', bg: 'bg-pink-500/10', border: 'border-pink-500/30', text: 'text-pink-400', minScore: 9.4, maxScore: 9.6 },
  { tier: 8, name: 'Quán Quân', title: 'Xuất Chúng', badge: '/ranks/tier_8.png', color: '#fbbf24', bg: 'bg-amber-500/15', border: 'border-amber-500/40', text: 'text-amber-300', minScore: 9.7, maxScore: 10.0 }
];
