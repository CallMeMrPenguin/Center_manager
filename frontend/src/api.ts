...
export const api = {
  ...
  getGradeAnalytics: (class_id?: number, student_id?: number) => {
    ...
    return request<{ session_records: any[]; all_session_records?: any[]; student_rankings: any[]; analytics_summary?: any; class_analytics_map?: Record<string, any> }>(`/api/reports/grade-analytics?${query}`);
  },
