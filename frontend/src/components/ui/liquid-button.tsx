...
const THEMES: Record<LiquidVariant, {
  ...
  indigo: {
    ...
    bgBase: 'bg-white',
    textBase: 'text-[#5c36f5]',
    textFilled: 'text-white',
    glowShadow: 'group-hover:shadow-[0_0_20px_rgba(92,54,245,0.4)]',
  ...
  cyan: {
    ...
    bgBase: 'bg-white',
    textBase: 'text-cyan-700',
    textFilled: 'text-white',
    glowShadow: 'group-hover:shadow-[0_0_20px_rgba(6,182,212,0.4)]',
  ...
  emerald: {
    ...
    bgBase: 'bg-white',
    textBase: 'text-emerald-700',
    textFilled: 'text-white',
    glowShadow: 'group-hover:shadow-[0_0_20px_rgba(16,185,129,0.4)]',
  ...
  amber: {
    ...
    bgBase: 'bg-white',
    textBase: 'text-amber-700',
    textFilled: 'text-white',
    glowShadow: 'group-hover:shadow-[0_0_20px_rgba(245,158,11,0.4)]',
  ...
  rose: {
    ...
    bgBase: 'bg-white',
    textBase: 'text-rose-700',
    textFilled: 'text-white',
    glowShadow: 'group-hover:shadow-[0_0_20px_rgba(244,63,94,0.4)]',
  ...
  purple: {
    ...
    bgBase: 'bg-white',
    textBase: 'text-purple-700',
    textFilled: 'text-white',
    glowShadow: 'group-hover:shadow-[0_0_20px_rgba(168,85,247,0.4)]',
