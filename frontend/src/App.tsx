...
function AppContent() {
  ...
  return (
    <div className="relative flex flex-col h-screen w-screen bg-[#e2e8f0] dark:bg-[#09090b] text-slate-900 dark:text-slate-50 overflow-hidden font-sans select-none">
      <div className="relative flex flex-row flex-1 overflow-hidden z-10">
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-transparent">
          <main className="flex-1 overflow-hidden bg-[#e2e8f0] dark:bg-[#09090b] relative">
            {visibleTabs.map((tab) => {
