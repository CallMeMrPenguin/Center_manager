...
The following mandatory rules MUST be strictly followed across all features, tables, search indices, and UI components in this repository:

---

## 📋 1. Table Pagination & Sorting Standards
...
## 🔍 2. Table Column Heading Filter Pattern (Ngân Hàng Câu Hỏi Standard)
...
## 📈 4. Graph & Chart Visual Standards
...
## 📅 5. Date Picker & Calendar Styling
...
## 🎨 6. Summary Card & Segmented Control UI Design System
...
## 🚫 7. Data Integrity: No Grade 0 Defaults
